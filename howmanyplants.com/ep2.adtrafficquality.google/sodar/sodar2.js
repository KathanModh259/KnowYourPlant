(function() {
    ...
    D.prototype.jumpThroughFinallyBlocks = D.prototype.aa;
    ...
    D.prototype.yieldAll = D.prototype.da;
    ...
    D.prototype.setFinallyBlock = D.prototype.ca;
    ...
    D.prototype.leaveFinallyBlock = D.prototype.ba;
    D.prototype.Z = function(a) {
        return new G(a)
    };
    D.prototype.forIn = D.prototype.Z;
    ...
    */
    ...
    function Ma(a, b) {
        var c;
        return J(function(d) {
            if (d.g == 1) return d.C(2), d.h(La(a, [1, b.ea, b.U, b.o]), 4);
    ...
    */
    ...
    function Qa(a) {
        this.url = (this.l = a) ? "https://ep1.adtrafficquality.google/pagead/gen_204?id=sodar2&v=253" : "https://pagead2.googlesyndication.com/pagead/gen_204?id=sodar2&v=253"
    }
    ...
    function V(a, b, c) {
        var d = new Qa(b === void 0 ? !1 : b.l),
            f = b === void 0 || b.R !== "0";
        c !== !1 && f || (d.url = d.l ? "https://ep1.adtrafficquality.google/pagead/sodar?id=sodar2&v=253" : "https://pagead2.googlesyndication.com/pagead/sodar?id=sodar2&v=253");
        U(d, "t", a);
        b && (U(d, "li", b.T), U(d, b.context === "cr" && b.O === "int" ? "bgai" : "jk", b.N));
        return d
    }
    ...
    function fb(a, b) {
        function c(g) {
            g && g.data !== null && g.origin === "https://www.google.com" && g.source != null && g.source === b.contentWindow && (a.h = "id=sodar2&v=253", a.config && (a.h += "&li=" + encodeURIComponent(a.config.T.toString()), a.h += "&" + (a.config.context === "cr" ? "bgai" : "jk") + "=" + encodeURIComponent(a.config.N.toString()), g.source.postMessage(JSON.stringify({
                id: "sodar",
                params: a.h
    ...
    function bb(a) {
        return window.location.host === (a.l ? "ep2.adtrafficquality.google" : "tpc.googlesyndication.com") || a.config.O === "int" ? !1 : !0
    }

    function db(a) {
        var b, c, d;
        return J(function(f) {
            if (f.g == 1) return b = M((a.l ? "https://ep2.adtrafficquality.google/sodar/" : "https://tpc.googlesyndication.com/sodar/") + "sodar2/253/runner.html"), f.h(xa(b), 2);
            if (f.g != 4) {
                c = f.j;
                ...
                return a.i.g ? (g = a.config, e = g.l ? "https://ep2.adtrafficquality.google" : "https://tpc.googlesyndication.com", e = e.indexOf("https:") === -1 ? "http:" + e : e, a.i.h.postMessage(JSON.stringify([g.context,
                    g.L, g.K, g.T, g.N, g.O, g.S === void 0 ? "n" : g.S, g.o === void 0 ? "0" : g.o, g.R === void 0 ? "1" : g.R, g.l === void 0 ? "0" : g.l ? "1" : "0"
                ]), e), f.return(void 0)) : f.h(Ma(a.i, {
                    ea: a.config.L,
                    U: a.config.K,
                    o: a.o,
                    l: a.config.l
